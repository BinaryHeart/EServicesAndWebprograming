...
I denna laboration kommer vi att arbeta med HTML, CSS, PHP, Javascript och MySQL. Slutresultatet kommer vara en sida där man kan posta gäsboksinlägg.
...
Skapa tabell som har hand om alla gästbooksinlägg och denna bör ha ett ID som skapas automatiskt av databasen, se auto increment. Den bör även ha en kolumn för en referens till ett annat inlägg. Detta är för att sedan i senare på laboration 3 skapa funktioner att man kan besvara andras inlägg. 
 ...
 \begin{itemize}
      ...
      \item Försök nu att skriva ut från databasen, ni väljer själva i vilken ordning. 
